...
<script type="text/javascript">
    ...
    $(function(){
    	...
    	$("#exit").click(function(){
    		...
    		parent.location = "${ctx}/loginServlet?action=logout";
    	})
	})
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<td class="topbg">
	  <table width="100%" border="0" cellpadding="0" cellspacing="0">
	    <tr>
		  <td height="50" class="toplink" align="right"><img src="${ctx}/images/top_home.gif">&nbsp;&nbsp;<a href="${ctx}/mainServlet?action=right" target="main">网站首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="${ctx}/images/top_exit.gif">&nbsp;&nbsp;<a href="${ctx}/loginServlet?action=logout" target="main" id="exit">注销退出</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		</tr>
		<tr>
