...
<form action="${ctx}/typeServlet?action=doAddOrEdit&dq=${dq}" id="typeForm" method="post">
    ...
    <td>
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">类型：<input type="text" name="name" id="name" value="${etype.name }" size="20"/></td>
		    		</tr>
		    		
		    	</table>
		    </td></tr>
			<tr><td align="left" class="fftd"><button>${etype.id eq null ? '添加':'修改' }</button><input type="reset" value="取消 "></td></tr>
		  </table>
	</td>
  </tr>
</table>
