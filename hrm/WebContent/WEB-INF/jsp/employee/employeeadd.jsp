	...
	<script type="text/javascript">
	    ...
	    $(function()
	    {
	    	...
	    	$("[name=cardId]").blur(function(){
				...
				$.get("${ctx}/employeeServlet?action=getcardid",{"cardId":cardId},function(data){
					if(data==1)
					   {
							cardIdFlag = 1;
			...
			$("#cardId").blur(function(){
				...
				var cardId = $("#cardId").val();
				//异步请求
				$.ajax("${ctx}/employeeServlet?action=getcardid",// 发送请求的URL字符串。
					{
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${ctx}/employeeServlet?action=doAdd" id="employeeForm" method="post">
		 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="name" id="name" size="20"/></td>       <!-- style="color:#F00" -->
		    			<td class="font3 fftd">身份证号码：<input type="text" name="cardId" id="cardId" size="20" /><span id="cardmsgid" ></span></td>
		    		</tr>
		    		<tr>
